...
export default function CustomerDetailsPage({ params }: { params: Promise<{ id: string }> }) {
  ...
  const handleStatusChange = async () => {
    try {
      const newStatus = customerDetails.status === "active" ? "inactive" : "active";
      // TODO: APIを呼び出してステータスを更新
      console.log(`Updating status for customer ${customerDetails.id} to ${newStatus}`);
          ...
          <div className="flex gap-4">
            ...
            <Dialog open={isConfirmDialogOpen} onOpenChange={setIsConfirmDialogOpen}>
              <DialogTrigger asChild>
                <Button
                  variant="outline"
                  className={customerDetails.status === "active" ? "text-red-600" : "text-green-600"}
                  onClick={() => setActionType(customerDetails.status === "active" ? "suspend" : "resume")}
                >
                  {customerDetails.status === "active" ? "利用停止" : "利用再開"}
                </Button>
              </DialogTrigger>
              <DialogContent>
                <DialogHeader>
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-900">{customerDetails.joinDate}</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-900">{customerDetails.lastLesson}</div>
                </div>
              </div>
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-gray-900">{customerDetails.attendanceRate}%</div>
                </div>
              </div>
            </div>
          </Card>
