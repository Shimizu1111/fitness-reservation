  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="container mx-auto p-8">
            ...
            {todayLessons.map((lesson) => (
              <Card key={lesson.id} className="p-6">
                <div className="flex justify-between items-start mb-4">
                  <div>
                    <h3 className="text-lg font-medium text-gray-900">{lesson.type}</h3>
                ...
                <div>
                  <h4 className="text-sm font-medium text-gray-700 mb-2">参加予定者</h4>
        ...
        <div>
          <div className="flex justify-between items-center mb-4">
            <h2 className="text-xl font-semibold text-gray-800">次回以降のレッスン</h2>
            <Link href="/trainer/lessons">
              <Button variant="ghost" className="text-sky-600 hover:text-sky-700">
                すべて見る
                <ChevronRight className="ml-1 h-4 w-4" />
